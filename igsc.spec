...
Version  : 0.9.4
Release  : 26
URL      : https://github.com/intel/igsc/archive/V0.9.4/igsc-0.9.4.tar.gz
Source0  : https://github.com/intel/igsc/archive/V0.9.4/igsc-0.9.4.tar.gz
...
%prep
%setup -q -n igsc-0.9.4
cd %{_builddir}/igsc-0.9.4
pushd ..
cp -a igsc-0.9.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727103360
mkdir -p clr-build
pushd clr-build
