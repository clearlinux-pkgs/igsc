...
Version  : 0.8.6
Release  : 3
URL      : https://github.com/intel/igsc/archive/V0.8.6/igsc-0.8.6.tar.gz
Source0  : https://github.com/intel/igsc/archive/V0.8.6/igsc-0.8.6.tar.gz
...
%prep
%setup -q -n igsc-0.8.6
cd %{_builddir}/igsc-0.8.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672177307
mkdir -p clr-build
pushd clr-build
