...
Version  : 0.8.20
Release  : 20
URL      : https://github.com/intel/igsc/archive/V0.8.20/igsc-0.8.20.tar.gz
Source0  : https://github.com/intel/igsc/archive/V0.8.20/igsc-0.8.20.tar.gz
...
%prep
%setup -q -n igsc-0.8.20
cd %{_builddir}/igsc-0.8.20
pushd ..
cp -a igsc-0.8.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721313800
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libigsc.so.0.8.20
/usr/lib64/libigsc.so.0
/usr/lib64/libigsc.so.0.8.20
