...
Source0  : https://github.com/intel/igsc/archive/V0.8.7/igsc-0.8.7.tar.gz
...
%prep
%setup -q -n igsc-0.8.7
cd %{_builddir}/igsc-0.8.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675119323
mkdir -p clr-build
pushd clr-build
