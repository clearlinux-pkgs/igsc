...
Version  : 0.9.5
Release  : 27
URL      : https://github.com/intel/igsc/archive/V0.9.5/igsc-0.9.5.tar.gz
Source0  : https://github.com/intel/igsc/archive/V0.9.5/igsc-0.9.5.tar.gz
...
%prep
%setup -q -n igsc-0.9.5
cd %{_builddir}/igsc-0.9.5
pushd ..
cp -a igsc-0.9.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731434880
mkdir -p clr-build
pushd clr-build
