...
%prep
%setup -q -n igsc-0.9.2
cd %{_builddir}/igsc-0.9.2
pushd ..
cp -a igsc-0.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721657460
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libigsc.so.0.9.0
/usr/lib64/libigsc.so.0
/usr/lib64/libigsc.so.0.9.0
