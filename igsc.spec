...
Version  : 0.9.6
Release  : 32
URL      : https://github.com/intel/igsc/archive/V0.9.6/igsc-0.9.6.tar.gz
Source0  : https://github.com/intel/igsc/archive/V0.9.6/igsc-0.9.6.tar.gz
...
%prep
%setup -q -n igsc-0.9.6
cd %{_builddir}/igsc-0.9.6
pushd ..
cp -a igsc-0.9.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750867853
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cmake/igsc/igscConfig.cmake
/usr/lib64/cmake/igsc/igscConfigVersion.cmake
/usr/lib64/cmake/igsc/igscTargets-relwithdebinfo.cmake
/usr/lib64/cmake/igsc/igscTargets.cmake
/usr/lib64/libigsc.so

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libigsc.so.0.9.6.0
/usr/lib64/libigsc.so.0
/usr/lib64/libigsc.so.0.9.6.0
